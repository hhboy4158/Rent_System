...
if(!isset($_SESSION['admin']) or $_SESSION['admin'] != $row['account']){
    // echo "<script>";
    // echo "alert(" . "session: " . $_SESSION['admin'] . $row['account']  .");";
    // echo "</script>";
...
<head>
    ...
    <title><?php echo $row['account'];?></title>
...
<body id="page-top">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">各種類食譜數量</h6>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">真的要登出嗎?</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">取消</button>
                    <button type="button" class="btn btn-primary" onclick="logout()">真的</button>
                    <!-- <a class="btn btn-primary" href="login.html">真的</a> -->
                </div>
            </div>
        </div>
    </div>
    ...
    let R_name = GetRecipeName();
    let R_count = GetRecipeCount();
    // GetRecipeCount();
    sleep(100).then(function() {
        RecipePieChart(R_name, R_count);
    })
    ...
    function PageLoad(pageValue){
        switch (pageValue) {
            case 'dashboard':
                ...
                break;
            case 'logout':
                $("#indexContent").load("pages/login/logout.php");
                break;
            default:
                $("#indexContent").load("pages/" + pageValue + ".php");
                break;
        }
    ...
    // $("#SectionSidebar").load("./pages/sidebar/sidebar.php");
    // const xhr = new XMLHttpRequest();
    // xhr.open("GET", "./pages/sidebar/sidebar.php", true);
    // xhr.send();

    // xhr.onreadystatechange = function() {
    //     if (xhr.readyState == 4 && xhr.status == 200) {

    //         document.querySelectorAll("#accordionSidebar")[0].innerHTML = xhr.responseText;
